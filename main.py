...
max_api_wait_time = 3
max_time = 10
apis = ['https://34.97.38.181/', 'https://invidious.nikkosphere.com/', 'https://super8.absturztau.be/', 'https://invidious.jing.rocks/', 'https://invidious.nerdvpn.de/', 'https://invidious.privacyredirect.com/', 'https://youtube.076.ne.jp/', 'https://inv.riverside.rocks/', 'https://invidio.xamh.de/', 'https://y.com.sb/', 'https://invidious.sethforprivacy.com/', 'https://invidious.tiekoetter.com/', 'https://inv.vern.cc/', 'https://inv.privacy.com.de/', 'https://invidious.rhyshl.live/', 'https://invidious.weblibre.org/', 'https://invidious.namazso.eu/', 'https://invidious.reallyaweso.me', 'https://invidious.adminforge.de', 'https://invidious.esmailelbob.xyz', 'https://invidious.perennialte.ch', 'https://invidious.dhusch.de', 'https://invidious.0011.lt', 'https://invidious.materialio.us', 'https://usa-proxy2.poketube.fun', 'https://invidious.darkness.service', 'https://invidious.flokinet.to', 'https://invidious.fdn.fr', 'https://iv.duti.dev', 'https://yt.artemislena.eu', 'https://invidious.projectsegfau.lt', 'https://id.420129.xyz', 'https://nyc1.iv.ggtyler.dev', 'https://inv.in.projectsegfau.lt', 'https://invidious.drgns.space', 'https://inv.us.projectsegfau.lt', 'https://youtube.mosesmang.com', 'https://invidious.incogniweb.net', 'https://invid-api.poketube.fun', 'https://inv.tux.pizza', 'https://pol1.iv.ggtyler.dev', 'https://invidious.protokolla.fi', 'https://invidious.einfachzocken.eu', 'https://yewtu.be', 'https://iv.datura.network', 'https://invidious.f5.si', 'https://invidious.privacydev.net', 'https://eu-proxy.poketube.fun', 'https://yt.drgnz.club', 'https://invidious.private.coffee', 'https://youtube.alt.tyil.nl/', 'https://rust.oskamp.nl/', 'https://iv.ggtyler.dev', 'https://invidious.nietzospannend.nl/', 'https://lekker.gay/']
